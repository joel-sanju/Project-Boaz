...
.delete_n{margin:3px; padding-right:20px; color:#F60; font-weight:bolder; cursor:pointer}
  ...
  <body>
   ...
   <section class="ftco-cover" style="background-image: linear-gradient(to bottom, rgba(2, 2, 2, 0.1), rgba(2, 2, 2, 0.1)), url(../images/banner.jpg); min-height:calc(100vh - 100px); background-size:cover; margin-bottom:0px;">
      <div class="container">
      ...
      <footer class="main-footer" style="margin-top:0px !important; padding-top:0px !important;">&nbsp;
        <div class="container-fluid">
          <div class="row">
            <div class="col-sm-6">
